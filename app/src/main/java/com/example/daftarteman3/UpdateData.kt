...
class UpdateData : AppCompatActivity() {
        ...
        update.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v: View?) {
                ...
                if (isEmpty(cekNama!!) || isEmpty(cekAlamat!!) || isEmpty(cekNoHP!!)) {
                    ...
                    val setdata_teman3 = data_teman3()
                    setdata_teman3.nama = new_nama.getText().toString()
                    setdata_teman3.alamat = new_alamat.getText().toString()
                    setdata_teman3.no_hp = new_nohp.getText().toString()
                    updateTeman(setdata_teman3)
                }
            }
        })
    }
    ...
    private fun updateTeman(teman: data_teman3) {
        val userID = auth!!.uid
        ...
        database!!.child("Admin")
            ...
            .addOnSuccessListener {
                ...
                new_alamat!!.setText("")
                new_nohp!!.setText("")
                Toast.makeText(this@UpdateData, "data berhasill diubah",
                Toast.LENGTH_SHORT).show()
                finish()
            }
    }
